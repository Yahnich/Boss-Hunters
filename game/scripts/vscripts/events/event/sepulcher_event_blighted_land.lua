...
local function FirstChoice(self, userid, event)
	...
	hero:AddBlessing("event_buff_blighted_land_blessing_1")
	hero:AddCurse("event_buff_blighted_land_curse")
...
local function SecondChoice(self, userid, event)
	...
	hero:AddBlessing("event_buff_blighted_land_blessing_2")
	hero:AddCurse("event_buff_blighted_land_curse")
	self._playerChoices[event.pID] = true
	CheckPlayerChoices(self)
end
...
local function StartEvent(self)
	...
	LinkLuaModifier("event_buff_blighted_land_curse", "events/modifiers/event_buff_blighted_land", LUA_MODIFIER_MOTION_NONE)
	LinkLuaModifier("event_buff_blighted_land_blessing_1", "events/modifiers/event_buff_blighted_land", LUA_MODIFIER_MOTION_NONE)
	LinkLuaModifier("event_buff_blighted_land_blessing_2", "events/modifiers/event_buff_blighted_land", LUA_MODIFIER_MOTION_NONE)
end
