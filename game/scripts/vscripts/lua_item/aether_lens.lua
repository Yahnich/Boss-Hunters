...
item_aether_lens = class(item_redium_lens)
...
function modifier_item_aether_derivative:GetModifierConstantManaRegen()
	return self.mr
end

function modifier_item_aether_derivative:GetModifierManaBonus()
	return self.mana
end
