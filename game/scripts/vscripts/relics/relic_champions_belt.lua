...
function relic_champions_belt:OnIntervalThink()
	self.str = 0
	self.agi = 0
	self.int = 0
...
function relic_champions_belt:DeclareFunctions()
...
function relic_champions_belt:GetModifierBonusStats_Strength()
	return self.str
end

function relic_champions_belt:GetModifierBonusStats_Agility()
	return self.agi
end