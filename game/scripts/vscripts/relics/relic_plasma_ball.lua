relic_plasma_ball = class(relicBaseClass)

if IsServer() then
	function relic_plasma_ball:OnCreated()
		self.charge = 0
	...
	function relic_plasma_ball:OnIntervalThink()
...
function relic_plasma_ball:IsHidden()
	return false
end