...
function relic_ritual_kris:DeclareFunctions()
	return {MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE}
end

function relic_ritual_kris:GetModifierPreAttack_CriticalStrike(params)
	if self:RollPRNG(10) and not params.attacker:HasModifier("relic_ritual_candle") then
