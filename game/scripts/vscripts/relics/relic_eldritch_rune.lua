relic_eldritch_rune = class(relicBaseClass)


function relic_eldritch_rune:DeclareFunctions()
	return {MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE}
end

function relic_eldritch_rune:GetModifierTotalDamageOutgoing_Percentage(params)
