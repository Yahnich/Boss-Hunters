relic_pocket_sand = class(relicBaseClass)

function relic_pocket_sand:OnIntervalThink()
	self:SetDuration(-1, true)
	self:StartIntervalThink(-1)
end

function relic_pocket_sand:DeclareFunctions()
...
function relic_pocket_sand:IsHidden()
	return false
end