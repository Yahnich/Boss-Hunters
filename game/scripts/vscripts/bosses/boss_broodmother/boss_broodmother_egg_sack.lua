...
if IsServer() then
	...
	function modifier_boss_broodmother_egg_sack_handler:OnIntervalThink()
		...
		local steppedOn = self:GetCaster():FindEnemyUnitsInRadius( parent:GetAbsOrigin(), 80, {flag = DOTA_UNIT_TARGET_FLAG_INVULNERABLE + DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES})
