...
function pugna_power_vacuum:GetIntriniscModifierName()
...
function modifier_pugna_power_vacuum:OnCreated()
	self.boss = self:GetTalentSpecialValueFor("boss_lifesteal")
	self.mob = self:GetTalentSpecialValueFor("mob_lifesteal")
end
