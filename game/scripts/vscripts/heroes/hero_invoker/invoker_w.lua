...
function invoker_w:IsStealable()
    return false
end

function invoker_w:IsHiddenWhenStolen()
    return false
end

function invoker_w:OnUpgrade()
    self:ReplaceOrbModifier()
end

function invoker_w:OnOwnerSpawned()
    self:ReplaceOrbModifier()
end
...
function invoker_w:ReplaceOrb()
    ...
    caster.invoked_orbs_particle[3] = ParticleManager:CreateParticle("particles/units/heroes/hero_invoker/invoker_wex_orb.vpcf", PATTACH_OVERHEAD_FOLLOW, caster)
...
function invoker_w:ReplaceOrbModifier()
    local caster = self:GetCaster()
...
function modifier_invoker_w:GetModifierAttackSpeedBonus_Constant()
    return self.bonus_as
end

function modifier_invoker_w:GetModifierMoveSpeedBonus_Percentage()
...
function modifier_invoker_w:GetTexture()
    return "invoker_wex"
end

function modifier_invoker_w:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_invoker_w:IsPurgeException()
    return false
end

function modifier_invoker_w:IsPurgable()
    return false
end
