...
function invoker_e:IsStealable()
    return false
end

function invoker_e:IsHiddenWhenStolen()
    return false
end

function invoker_e:OnUpgrade()
    self:ReplaceOrbModifier()
end

function invoker_e:OnOwnerSpawned()
    self:ReplaceOrbModifier()
end
...
function invoker_e:ReplaceOrb()
    ...
    caster.invoked_orbs_particle[3] = ParticleManager:CreateParticle("particles/units/heroes/hero_invoker/invoker_exort_orb.vpcf", PATTACH_OVERHEAD_FOLLOW, caster)
...
function invoker_e:ReplaceOrbModifier()
    local caster = self:GetCaster()
...
function modifier_invoker_e:OnCreated(table)
    self.bonus_ad = self:GetSpecialValueFor("bonus_ad")
end

function modifier_invoker_e:OnRefresh(table)
    self.bonus_ad = self:GetSpecialValueFor("bonus_ad")
end
...
function modifier_invoker_e:GetModifierPreAttack_BonusDamage()
    return self.bonus_ad
end

function modifier_invoker_e:IsDebuff()
    return false
end

function modifier_invoker_e:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_invoker_e:GetTexture()
    return "invoker_exort"
end

function modifier_invoker_e:IsPurgeException()
    return false
end

function modifier_invoker_e:IsPurgable()
    return false
end
