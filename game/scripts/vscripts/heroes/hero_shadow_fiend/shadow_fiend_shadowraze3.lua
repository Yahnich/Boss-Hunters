shadow_fiend_shadowraze3 = class({})
...
function shadow_fiend_shadowraze3:GetCastRange(vLocation, hTarget)
...
function shadow_fiend_shadowraze3:GetCooldown(iLvl)
...
function shadow_fiend_shadowraze3:OnSpellStart()
...
function shadow_fiend_shadowraze3:singleRaze()
...
function shadow_fiend_shadowraze3:LineRaze()
	local caster = self:GetCaster()
	...
	for i=radius/2,distance,radius/2 do
		local position = startPos + direction * i
		position = GetGroundPosition(position, caster)
