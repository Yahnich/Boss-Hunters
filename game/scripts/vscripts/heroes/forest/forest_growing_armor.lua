...
LinkLuaModifier( "modifier_forest_growing_armor_buff", "heroes/hero_fg/forest_growing_armor.lua" ,LUA_MODIFIER_MOTION_NONE )
...
function modifier_forest_growing_armor_buff:OnCreated()
	...
	self.talentregen =  self:FindTalentValue("special_bonus_unique_treant")
end
...
function modifier_forest_growing_armor_buff:GetEffectName()
