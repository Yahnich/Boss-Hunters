...
function modifier_disruptor_thunder_strike_bh:OnCreated(kv)
	self.strikes = kv.strikes or self:GetSpecialValueFor("strikes")
	self.tick = self:GetSpecialValueFor("strike_interval")
	self.damage = self:GetSpecialValueFor("strike_damage")
