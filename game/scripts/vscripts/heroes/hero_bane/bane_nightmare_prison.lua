...
if IsServer() then
	...
	function modifier_bane_nightmare_prison_fear:OnIntervalThink()
	...
	function modifier_bane_nightmare_prison_fear:OnDestroy()
		local parent = self:GetParent()
		local caster = self:GetCaster()
		StopSoundOn("Hero_Bane.Nightmare.Loop", self:GetParent())
		EmitSoundOn("Hero_Bane.Nightmare.End", self:GetParent())
...
function modifier_bane_nightmare_prison_fear:GetStatusEffectName()
	return "particles/status_fx/status_effect_nightmare.vpcf"
end

function modifier_bane_nightmare_prison_fear:StatusEffectPriority()
	return 10
end
