...
function item_keshas_booze_barrel:OnSpellStart()
	...
	self:GetCaster():FindModifierByName("modifier_item_keshas_booze_barrel"):SetStackCount(0)
end
...
modifier_item_keshas_booze_barrel = class({})
...
function modifier_item_keshas_booze_barrel_ally:OnDestroy()
	if IsServer() then self:GetCaster():FindModifierByName("modifier_item_keshas_booze_barrel"):SetStackCount(1) end
end
...
function modifier_keshas_booze_barrel_enemy:OnRemoved()
	if IsServer() then 
		...
		self:GetCaster():FindModifierByName("modifier_item_keshas_booze_barrel"):SetStackCount(1)
	end
end
