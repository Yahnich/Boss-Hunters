...
function item_quick_stone:RuneProcessing( item, itemmodifier, slotIndex )
	...
	item.itemData[slotIndex].funcs["GetModifierAttackSpeedBonus"] = (item.itemData[slotIndex].funcs["GetModifierAttackSpeedBonus"] or 0) + self:GetLevelSpecialValueFor( "attack_speed", level-1 )
end
...
function modifier_item_quick_stone_passive:GetModifierAttackSpeedBonus()
	return self.as
end