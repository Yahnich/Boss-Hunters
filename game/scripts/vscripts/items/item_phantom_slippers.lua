...
function item_phantom_slippers:GetRuneSlots()
...
item_phantom_slippers_5 = class(item_phantom_slippers)

function item_phantom_slippers_5:OnSpellStart()
	local caster = self:GetCaster()
	caster:AddNewModifier(caster, self, "modifier_item_phantom_slippers_flight", {duration = self:GetSpecialValueFor("duration")} )
end

item_phantom_slippers_6 = class(item_phantom_slippers_5)
item_phantom_slippers_7 = class(item_phantom_slippers_5)
item_phantom_slippers_8 = class(item_phantom_slippers_5)
item_phantom_slippers_9 = class(item_phantom_slippers_5)
